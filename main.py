...
def read_env():
    ...
    return TOKEN, IMG_CHANNEL_ID, TEAM, RESULTS_CHANNEL, LOOT_PATH_CHANNEL_ID

def main():
    TOKEN, IMG_CHANNEL_ID, TEAM, RESULTS_CHANNEL, LOOT_PATH_CHANNEL_ID = read_env()
    intents = discord.Intents.default()
    intents.message_content = True

    client = MyClient(intents=intents)
    client.add_variables(IMG_CHANNEL_ID, TEAM, RESULTS_CHANNEL, LOOT_PATH_CHANNEL_ID)
    client.run(TOKEN)
